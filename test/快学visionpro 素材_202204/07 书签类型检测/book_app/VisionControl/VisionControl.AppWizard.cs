...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    private const string mVppFilename = @"C:\Users\lilywang\Desktop\视频录制\07 书签类型检测\7.vpp";
    ...
    private static DateTime mGenerationDateTime = new DateTime(2021,11,22,9,0,58);
