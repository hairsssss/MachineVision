...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    this.tabPage_Job0_书签检测 = new System.Windows.Forms.TabPage();
    this.label_Job0_书签类型 = new System.Windows.Forms.Label();
    this.textBox_Job0_书签类型 = new System.Windows.Forms.TextBox();
    ...
    this.tabPage_Job0_书签检测.SuspendLayout();
      this.SuspendLayout();
    // 
    ...
    this.cogToolPropertyProvider0.Subject = null;
      ...
      // tabPage_Job0_书签检测
      // 
      this.tabPage_Job0_书签检测.Name = "tabPage_Job0_书签检测";
      this.tabPage_Job0_书签检测.Location = new System.Drawing.Point(0, 0);
      this.tabPage_Job0_书签检测.Size = new System.Drawing.Size(400, 350);
      this.tabPage_Job0_书签检测.TabIndex = 0;
      this.tabPage_Job0_书签检测.TabStop = false;
      this.tabPage_Job0_书签检测.Text = "书签检测";
      this.tabPage_Job0_书签检测.Enabled = true;
      this.tabPage_Job0_书签检测.Anchor = (AnchorStyles.Top | AnchorStyles.Left);
      this.tabPage_Job0_书签检测.AutoScroll = true;
      this.tabPage_Job0_书签检测.Controls.Add(label_Job0_书签类型);
      this.tabPage_Job0_书签检测.Controls.Add(textBox_Job0_书签类型);
      // 
      // label_Job0_书签类型
      // 
      this.label_Job0_书签类型.Name = "label_Job0_书签类型";
      this.label_Job0_书签类型.Location = new System.Drawing.Point(14, 20);
      this.label_Job0_书签类型.Size = new System.Drawing.Size(202, 23);
      this.label_Job0_书签类型.TabIndex = 0;
      this.label_Job0_书签类型.TabStop = false;
      this.label_Job0_书签类型.Text = "书签类型：";
      this.label_Job0_书签类型.Enabled = true;
      this.label_Job0_书签类型.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
      // 
      // textBox_Job0_书签类型
      // 
      this.textBox_Job0_书签类型.Name = "textBox_Job0_书签类型";
      this.textBox_Job0_书签类型.Location = new System.Drawing.Point(234, 18);
      this.textBox_Job0_书签类型.Size = new System.Drawing.Size(150, 21);
      this.textBox_Job0_书签类型.TabIndex = 1;
      this.textBox_Job0_书签类型.TabStop = true;
      this.textBox_Job0_书签类型.Text = "";
      this.textBox_Job0_书签类型.Enabled = true;
      this.textBox_Job0_书签类型.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
      this.textBox_Job0_书签类型.ReadOnly = false;
      ...
      this.tabControl_JobTabs.Controls.Add(this.tabPage_Job0_书签检测);
    this.tabPage_Job0_书签检测.ResumeLayout(false);
    ...
    private TabPage tabPage_Job0_书签检测;
    private Label label_Job0_书签类型;
    private TextBox textBox_Job0_书签类型;
