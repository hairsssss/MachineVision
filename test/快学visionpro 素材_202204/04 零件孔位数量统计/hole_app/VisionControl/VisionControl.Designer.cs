...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    this.tabPage_Job0_孔位数据 = new System.Windows.Forms.TabPage();
    this.label_Job0_总数 = new System.Windows.Forms.Label();
    this.textBox_Job0_总数 = new Cognex.VisionPro.QuickBuild.Implementation.Internal.CogApplicationWizardNumberBox();
    ...
    this.tabPage_Job0_孔位数据.SuspendLayout();
      this.SuspendLayout();
    // 
    ...
    this.cogToolPropertyProvider0.Subject = null;
      ...
      // tabPage_Job0_孔位数据
      // 
      this.tabPage_Job0_孔位数据.Name = "tabPage_Job0_孔位数据";
      this.tabPage_Job0_孔位数据.Location = new System.Drawing.Point(0, 0);
      this.tabPage_Job0_孔位数据.Size = new System.Drawing.Size(400, 350);
      this.tabPage_Job0_孔位数据.TabIndex = 0;
      this.tabPage_Job0_孔位数据.TabStop = false;
      this.tabPage_Job0_孔位数据.Text = "孔位数据";
      this.tabPage_Job0_孔位数据.Enabled = true;
      this.tabPage_Job0_孔位数据.Anchor = (AnchorStyles.Top | AnchorStyles.Left);
      this.tabPage_Job0_孔位数据.AutoScroll = true;
      this.tabPage_Job0_孔位数据.Controls.Add(label_Job0_总数);
      this.tabPage_Job0_孔位数据.Controls.Add(textBox_Job0_总数);
      // 
      // label_Job0_总数
      // 
      this.label_Job0_总数.Name = "label_Job0_总数";
      this.label_Job0_总数.Location = new System.Drawing.Point(14, 20);
      this.label_Job0_总数.Size = new System.Drawing.Size(202, 23);
      this.label_Job0_总数.TabIndex = 0;
      this.label_Job0_总数.TabStop = false;
      this.label_Job0_总数.Text = "总数：";
      this.label_Job0_总数.Enabled = true;
      this.label_Job0_总数.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
      // 
      // textBox_Job0_总数
      // 
      this.textBox_Job0_总数.Name = "textBox_Job0_总数";
      this.textBox_Job0_总数.Location = new System.Drawing.Point(234, 18);
      this.textBox_Job0_总数.Size = new System.Drawing.Size(150, 21);
      this.textBox_Job0_总数.TabIndex = 1;
      this.textBox_Job0_总数.TabStop = true;
      this.textBox_Job0_总数.Text = "";
      this.textBox_Job0_总数.Enabled = true;
      this.textBox_Job0_总数.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
      this.textBox_Job0_总数.ReadOnly = false;
      ...
      this.tabControl_JobTabs.Controls.Add(this.tabPage_Job0_孔位数据);
    this.tabPage_Job0_孔位数据.ResumeLayout(false);
    ...
    private TabPage tabPage_Job0_孔位数据;
    private Label label_Job0_总数;
    private Cognex.VisionPro.QuickBuild.Implementation.Internal.CogApplicationWizardNumberBox textBox_Job0_总数;
