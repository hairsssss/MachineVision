...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    this.tabPage_Job0_检测 = new System.Windows.Forms.TabPage();
    this.label_Job0_检测结果 = new System.Windows.Forms.Label();
    this.textBox_Job0_检测结果 = new System.Windows.Forms.TextBox();
    ...
    this.tabPage_Job0_检测.SuspendLayout();
      this.SuspendLayout();
    // 
    ...
    this.cogToolPropertyProvider0.Subject = null;
      ...
      // tabPage_Job0_检测
      // 
      this.tabPage_Job0_检测.Name = "tabPage_Job0_检测";
      this.tabPage_Job0_检测.Location = new System.Drawing.Point(0, 0);
      this.tabPage_Job0_检测.Size = new System.Drawing.Size(400, 350);
      this.tabPage_Job0_检测.TabIndex = 0;
      this.tabPage_Job0_检测.TabStop = false;
      this.tabPage_Job0_检测.Text = "检测";
      this.tabPage_Job0_检测.Enabled = true;
      this.tabPage_Job0_检测.Anchor = (AnchorStyles.Top | AnchorStyles.Left);
      this.tabPage_Job0_检测.AutoScroll = true;
      this.tabPage_Job0_检测.Controls.Add(label_Job0_检测结果);
      this.tabPage_Job0_检测.Controls.Add(textBox_Job0_检测结果);
      // 
      // label_Job0_检测结果
      // 
      this.label_Job0_检测结果.Name = "label_Job0_检测结果";
      this.label_Job0_检测结果.Location = new System.Drawing.Point(14, 20);
      this.label_Job0_检测结果.Size = new System.Drawing.Size(202, 23);
      this.label_Job0_检测结果.TabIndex = 0;
      this.label_Job0_检测结果.TabStop = false;
      this.label_Job0_检测结果.Text = "检测结果";
      this.label_Job0_检测结果.Enabled = true;
      this.label_Job0_检测结果.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
      // 
      // textBox_Job0_检测结果
      // 
      this.textBox_Job0_检测结果.Name = "textBox_Job0_检测结果";
      this.textBox_Job0_检测结果.Location = new System.Drawing.Point(234, 18);
      this.textBox_Job0_检测结果.Size = new System.Drawing.Size(150, 21);
      this.textBox_Job0_检测结果.TabIndex = 1;
      this.textBox_Job0_检测结果.TabStop = true;
      this.textBox_Job0_检测结果.Text = "";
      this.textBox_Job0_检测结果.Enabled = true;
      this.textBox_Job0_检测结果.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
      this.textBox_Job0_检测结果.ReadOnly = false;
      ...
      this.tabControl_JobTabs.Controls.Add(this.tabPage_Job0_检测);
    this.tabPage_Job0_检测.ResumeLayout(false);
    ...
    private TabPage tabPage_Job0_检测;
    private Label label_Job0_检测结果;
    private TextBox textBox_Job0_检测结果;
