...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    private const string mVppFilename = @"D:\A_material\MachineVision\test\VisionPro\4.零件孔位数量统计\零件孔位数量统计.vpp";
    private const string mApplicationName = "零件孔位数量统计";
    ...
    private static DateTime mGenerationDateTime = new DateTime(2023,11,29,6,18,40);
    ...
    private void Wizard_AddJobTabs(System.Collections.ArrayList newPagesList)
    {
      ...
      {
        case 0:
          newPagesList.Add(tabPage_Job0_孔位数);
          break;
      }
