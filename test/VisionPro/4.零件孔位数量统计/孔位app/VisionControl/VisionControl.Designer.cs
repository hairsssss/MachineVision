...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    this.tabPage_Job0_孔位数 = new System.Windows.Forms.TabPage();
    ...
    this.tabPage_Job0_孔位数.SuspendLayout();
      this.SuspendLayout();
    // 
    ...
    this.cogToolPropertyProvider0.Subject = null;
      ...
      // tabPage_Job0_孔位数
      // 
      this.tabPage_Job0_孔位数.Name = "tabPage_Job0_孔位数";
      this.tabPage_Job0_孔位数.Location = new System.Drawing.Point(0, 0);
      this.tabPage_Job0_孔位数.Size = new System.Drawing.Size(400, 350);
      this.tabPage_Job0_孔位数.TabIndex = 0;
      this.tabPage_Job0_孔位数.TabStop = false;
      this.tabPage_Job0_孔位数.Text = "孔位数";
      this.tabPage_Job0_孔位数.Enabled = true;
      this.tabPage_Job0_孔位数.Anchor = (AnchorStyles.Top | AnchorStyles.Left);
      this.tabPage_Job0_孔位数.AutoScroll = true;
      this.tabPage_Job0_孔位数.Controls.Add(label_Job0_总数);
      this.tabPage_Job0_孔位数.Controls.Add(textBox_Job0_总数);
      // 
      // label_Job0_总数
      // 
      ...
      this.tabControl_JobTabs.Controls.Add(this.tabPage_Job0_孔位数);
    this.tabPage_Job0_孔位数.ResumeLayout(false);
    ...
    private TabPage tabPage_Job0_孔位数;
