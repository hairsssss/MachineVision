...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    private const string mVppFilename = @"D:\A_material\MachineVision\test\VisionPro\7.书签类型检测\书签类型检测.vpp";
    private const string mApplicationName = "书签类型检测";
    ...
    private static DateTime mGenerationDateTime = new DateTime(2023,11,29,8,13,20);
    ...
    private void Wizard_FormLoad()
    {
      ...
      Utility.SetupPropertyProvider(cogToolPropertyProvider0, textBox_Job0_书签类型, mJM.Job(0).VisionTool, "Tools.Item[\"CogToolBlock1\"].(Cognex.VisionPro.ToolBlock.CogToolBlock).Outputs.Item[\"type\"].Value.(System.String)");
    ...
    private void Wizard_EnableControls(bool running)
    {
      ...
      textBox_Job0_书签类型.Enabled = ! running;
    ...
    private void Wizard_AddJobTabs(System.Collections.ArrayList newPagesList)
    {
      ...
      {
        case 0:
          newPagesList.Add(tabPage_Job0_书签检测);
          break;
      }
