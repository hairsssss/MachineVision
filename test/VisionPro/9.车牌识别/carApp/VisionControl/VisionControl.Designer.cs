...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    {
    this.tabPage_Job0_车牌识别 = new System.Windows.Forms.TabPage();
    this.label_Job0_车牌号 = new System.Windows.Forms.Label();
    this.textBox_Job0_车牌号 = new System.Windows.Forms.TextBox();
    ...
    this.tabPage_Job0_车牌识别.SuspendLayout();
      this.SuspendLayout();
      // 
      // tabPage_Job0_车牌识别
      // 
      this.tabPage_Job0_车牌识别.Name = "tabPage_Job0_车牌识别";
      this.tabPage_Job0_车牌识别.Location = new System.Drawing.Point(0, 0);
      this.tabPage_Job0_车牌识别.Size = new System.Drawing.Size(400, 350);
      this.tabPage_Job0_车牌识别.TabIndex = 0;
      this.tabPage_Job0_车牌识别.TabStop = false;
      this.tabPage_Job0_车牌识别.Text = "车牌识别";
      this.tabPage_Job0_车牌识别.Enabled = true;
      this.tabPage_Job0_车牌识别.Anchor = (AnchorStyles.Top | AnchorStyles.Left);
      this.tabPage_Job0_车牌识别.AutoScroll = true;
      this.tabPage_Job0_车牌识别.Controls.Add(label_Job0_车牌号);
      this.tabPage_Job0_车牌识别.Controls.Add(textBox_Job0_车牌号);
      // 
      // label_Job0_车牌号
      // 
      this.label_Job0_车牌号.Name = "label_Job0_车牌号";
      this.label_Job0_车牌号.Location = new System.Drawing.Point(14, 20);
      this.label_Job0_车牌号.Size = new System.Drawing.Size(202, 23);
      this.label_Job0_车牌号.TabIndex = 0;
      this.label_Job0_车牌号.TabStop = false;
      this.label_Job0_车牌号.Text = "车牌号：";
      this.label_Job0_车牌号.Enabled = true;
      this.label_Job0_车牌号.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
      // 
      // textBox_Job0_车牌号
      // 
      this.textBox_Job0_车牌号.Name = "textBox_Job0_车牌号";
      this.textBox_Job0_车牌号.Location = new System.Drawing.Point(234, 18);
      this.textBox_Job0_车牌号.Size = new System.Drawing.Size(150, 21);
      this.textBox_Job0_车牌号.TabIndex = 1;
      this.textBox_Job0_车牌号.TabStop = true;
      this.textBox_Job0_车牌号.Text = "";
      this.textBox_Job0_车牌号.Enabled = true;
      this.textBox_Job0_车牌号.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
      this.textBox_Job0_车牌号.ReadOnly = true;
      ...
      this.tabControl_JobTabs.Controls.Add(this.tabPage_Job0_车牌识别);
    this.tabPage_Job0_车牌识别.ResumeLayout(false);
    ...
    private TabPage tabPage_Job0_车牌识别;
    private Label label_Job0_车牌号;
    private TextBox textBox_Job0_车牌号;
