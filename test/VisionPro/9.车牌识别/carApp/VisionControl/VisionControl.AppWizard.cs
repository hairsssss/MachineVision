...
namespace VisionControl
{
  partial class VisionControl
  {
    ...
    private const string mVppFilename = @"D:\A_material\MachineVision\test\VisionPro\9.车牌识别\QuickBuild1.vpp";
    ...
    private static DateTime mGenerationDateTime = new DateTime(2023,12,1,6,35,56);
    ...
    private void Wizard_UpdateJobResults(int idx, Cognex.VisionPro.ICogRecord result)
    {
      ...
      {
        case 0:
          Utility.FillUserResultData(textBox_Job0_车牌号, result, "cardPlate", false);
          break;
      }
